					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
							...
							<div class="container-fluid d-flex align-items-stretch justify-content-between">
								<p class="fs-1 text-white fw-bold">victor</p>	
							</div>
						</div>
						<!--end::Logo-->
						<!--begin::sidebar menu-->
							...
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" style="height: 546px;">
								...
								<div class="menu menu-column menu-rounded menu-sub-indention fw-semibold px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
									...
									<div data-kt-menu-trigger="click" class="menu-item here menu-accordion hover show">
										...
										<!--end:Menu link-->
										<!--begin:Menu sub-->
										<div class="menu-sub menu-sub-accordion show" kt-hidden-height="443" style="">
											<!--begin:Menu item-->
											<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion hiding hover show">
												<!--begin:Menu link-->
												<span class="menu-link">
												...
												<div class="menu-sub menu-sub-accordion">
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link active" href="/login">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="/videos/categorias">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="/videos/agregar">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Agregar video</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="/videos/editar">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Editar Video</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="/videos/categorias/agregar">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
													...
													<div class="menu-item">
														<!--begin:Menu link-->
														<a class="menu-link" href="/videos/categorias/editar">
															<span class="menu-bullet">
																<span class="bullet bullet-dot"></span>
															</span>
															<span class="menu-title">Editar Categoria</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
											...
											<div class="card mb-5 mb-xl-8">
												...
												<div class="card-body pt-15">
													...
													<div class="d-flex flex-center flex-column mb-5">
														<!--begin::Name-->
														<h1 class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1">{{$video->nombre}}</h1>
														<!--end::Name-->
													</div>
													<!--end::Summary-->
													<!--begin::Details toggle-->
													<div class="d-flex flex-stack fs-4 py-3">
														<div class="badge badge-light-info d-inline">Descripcion</div>
														<div class="badge badge-light-info d-inline">{{$video->descripcion}}</div>
													</div>
													<div class="d-flex flex-stack fs-4 py-3">
														<div class="badge badge-light-info d-inline">Url</div>
														<div class="badge badge-light-info d-inline">{{$video->url}}</div>
													</div>
													<div class="row">
														<div class="col">
															<div class="badge badge-light-primary d-inline">Propietario: {{$propietario->nombre}}</div>
														</div>
														<div class="col">
															<br>
															<div class="badge badge-light-primary d-inline">Subido el: {{$video->created_at}}</div>
														</div>
													</div>
														<!--begin::Badge-->
													<!--end::Details toggle-->
													...
													<div class="card pt-4 mb-6 mb-xl-9">
														...
														<div class="card-header border-0">
															...
															<div class="row">
																...
																<div class="col">
																	<button class="btn btn-primary" type="button" id="comentar">comentar</button>
																</div>
															</div>
															<!--end::Card title-->
														</div>
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<td class="text-gray-800">**** 5948</td>
																				</tr>
																				<tr>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 8432</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 6790</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
...
<script type="text/javascript">
	$(function(){
		var t = $("#kt_table_customers_payment").DataTable();

		@foreach ($usuarios as $usr)
			@foreach ($comentarios as $com)
				@if ($com->usrId == $usr["_id"])
					t.row.add([
						"{{$usr["nombre"]}}",
						"{{$com->comentario}}"
					]).draw();
	...
	$("#comentar").click(function(){
		$.post("/video/comentar", {comentario:$("#comentario").val(),video:$("#video").val()},
			function(data, status){
				var t = $("#kt_table_customers_payment").DataTable();

				t.row.add([
					"{{session()->get('USR')->nombre}}",
					$("#comentario").val()
				]).draw();
		});
	});
