			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				<div id="kt_app_header" class="app-header">
					...
					<div class="container-fluid d-flex align-items-stretch justify-content-between">
						<p class="fw-bold" style="font-size: xxx-large;">MOONS</p>	
						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Form-->
									<form id="kt_form" class="form d-flex flex-column flex-lg-row" action="/videos/agregar" method="POST">
														...
														<div class="card card-flush py-4">
															...
															<div class="card-body pt-0">
																...
																<div class="mb-10 fv-row">
																	...
																	<!--end::Label-->
																	<!--begin::Input-->
																	<input type="text" name="url" class="form-control mb-2" value="" />
																	<!--end::Input-->
																	<!--begin::Description-->
																	<div class="text-muted fs-7"></div>
																	<!--end::Description-->
																...
																<div>
																	...
																	<!--end::Label-->
																	<!--begin::Editor-->
																	<div id="kt_ecommerce_add_product_description" name="descripcion" class="min-h-200px mb-2"></div>
																	<!--end::Editor-->
																	<!--begin::Description-->
																	<div class="text-muted fs-7"></div>
																	<!--end::Description-->
																...
																<div>
																	...
																	<select class="form-select" name="categoria" id="categoria">
																		...
																		<option value={{$cat->_id}}>{{$cat->valor}}</option>
